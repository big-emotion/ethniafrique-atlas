    ...
    <main className="container mx-auto px-4 py-10">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p>
            Aujourd’hui, je collecte progressivement les informations
            disponibles pour les organiser dans ce dictionnaire.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            corrections, ou simplement des idées d’amélioration.
          </p>
          <p>
            Si vous souhaitez aider, n’hésitez pas à me contacter ou à proposer
            directement sur le{" "}
            <a
        ...
        <section className="space-y-4">
          ...
          <p>
            I am currently collecting and organizing available information to
            include it in this dictionary.
          </p>
          <p>
          ...
          <h4 className="text-lg font-medium pt-2">
        ...
        <section className="space-y-4">
          ...
          <p>
            Actualmente estoy recopilando y organizando la información
            disponible para incluirla en este diccionario.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p>
            Atualmente, estou coletando e organizando informações disponíveis
            para incluí-las neste dicionário.
          </p>
          <p>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Vous souhaitez me contacter ou proposer une contribution ? Utilisez
